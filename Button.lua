...
function ButtonModule.Create(ParentFrame, Options)
    ...
    -- 1. الزر الأساسي (تم تقليل العرض ليكون عائماً ولا يلتصق بالحواف)
    local Button = Instance.new("TextButton")
    Button.Name = text .. "_Btn"
    Button.Size = UDim2.new(1, -24, 0, 42) -- يترك مساحة 12 بكسل من كل جهة
    Button.Position = UDim2.new(0.5, 0, 0, 0)
    Button.AnchorPoint = Vector2.new(0.5, 0)
    Button.BackgroundColor3 = BUTTON_BG
    Button.Text = "" 
    Button.AutoButtonColor = false
    -- تفعيل القص لضمان عدم خروج الصور أو الألوان خارج الحواف الدائرية
    ...
    -- 2. إطار الزر (UIStroke) بلمسة خفيفة
