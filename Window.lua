...
function AxisUI.CreateWindow(Options)
    ...
    local function CreateTopIconBtn(name, iconId, posOffset)
        ...
        -- تطبيق الجرادينت بشكل دائم على جميع الأزرار
    ...
    self.TransBtn = CreateTopIconBtn("Transparency", "rbxassetid://101356891567422", -145) -- زر الشفافية الجديد
    ...
    -- منطق زر الشفافية (Transparency Toggle)
    local isTransparent = false
    self.TransBtn.MouseButton1Click:Connect(function()
        isTransparent = not isTransparent
        -- تغيير شفافية الخلفية إلى 0.4 للحصول على مظهر الـ Acrylic
